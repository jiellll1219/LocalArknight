package com.hypergryph.arknights.core.dao;import com.alibaba.fastjson.JSON;
...
import org.springframework.jdbc.core.RowMapper;public class mailDao
{
  ...
  public static int setMailItems(int id, JSONArray items) {
     ...
     Object[] params = { JSON.toJSONString(items, new SerializerFeature[] { SerializerFeature.WriteMapNullValue }), Integer.valueOf(id) };
     return ArknightsApplication.jdbcTemplate.update(sql, params);
  }
