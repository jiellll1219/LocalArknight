 ...
 public class get
 {
   public static Boolean GM_ItemGet(Long uid, int count, String itemType, String itemId) {
     ...
     if (itemType.equals("TKT_TRY")) {
       UserSyncData.getJSONObject("status").put("practiceTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("practiceTicket") + count));
     }
     if (itemType.equals("DIAMOND")) {
       UserSyncData.getJSONObject("status").put("androidDiamond", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("androidDiamond") + count));
       UserSyncData.getJSONObject("status").put("iosDiamond", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("iosDiamond") + count));
     } 
     if (itemType.equals("DIAMOND_SHD")) {
       UserSyncData.getJSONObject("status").put("diamondShard", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("diamondShard") + count));
     }
     ...
     if (itemType.equals("TKT_RECRUIT")) {
       UserSyncData.getJSONObject("status").put("recruitLicense", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("recruitLicense") + count));
     }
     if (itemType.equals("TKT_INST_FIN")) {
       UserSyncData.getJSONObject("status").put("instantFinishTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("instantFinishTicket") + count));
     }
     if (itemType.equals("LGG_SHD")) {
       UserSyncData.getJSONObject("status").put("lggShard", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("lggShard") + count));
     }
     if (itemType.equals("HGG_SHD")) {
       UserSyncData.getJSONObject("status").put("hggShard", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("hggShard") + count));
     }
     if (itemType.equals("TKT_GACHA")) {
       UserSyncData.getJSONObject("status").put("gachaTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("gachaTicket") + count));
     }
     if (itemType.equals("TKT_GACHA_10")) {
       UserSyncData.getJSONObject("status").put("tenGachaTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("tenGachaTicket") + count));
     }
     if (itemType.equals("VOUCHER_PICK")) {
       ...
       UserSyncData.getJSONObject("consumable").getJSONObject(itemId).getJSONObject("0").put("count", Integer.valueOf(UserSyncData.getJSONObject("consumable").getJSONObject(itemId).getJSONObject("0").getIntValue("count") + count));
     } 
   ...
   public static JSONObject GM_CharGet(Long uid, String charId) {
     ...
     for (int i = 0; i < UserSyncData.getJSONObject("troop").getJSONObject("chars").size(); i++) {
       if (UserSyncData.getJSONObject("troop").getJSONObject("chars").getJSONObject(String.valueOf(i + 1)).getString("charId").equals(charId)) {
         repeatCharId = i + 1;
     ...
     if (repeatCharId == 0) {
       ...
       UserSyncData.getJSONObject("inventory").put("p_" + charId, Integer.valueOf(UserSyncData.getJSONObject("inventory").getIntValue("p_" + charId) + 1));
