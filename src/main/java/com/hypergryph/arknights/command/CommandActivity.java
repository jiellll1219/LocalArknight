...
public class CommandActivity
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException {
    if (args.length >= 3) {
      ...
      UserSyncData.getJSONObject("activity").getJSONObject(activityType).put(activityId,
          activity.getJSONObject("activity").getJSONObject(activityType).getJSONObject(activityId));
