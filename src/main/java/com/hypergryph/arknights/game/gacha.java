...
public class gacha {
   ...
   public JSONObject SyncNormalGacha(@RequestHeader("secret") String secret, HttpServletResponse response,
   ...
   public JSONObject normalGacha(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      ...
      UserSyncData.getJSONObject("recruit").getJSONObject("normal").getJSONObject("slots")
            .getJSONObject(String.valueOf(slotId)).put("state", Integer.valueOf(2));
      ...
      UserSyncData.getJSONObject("recruit").getJSONObject("normal").getJSONObject("slots")
            .getJSONObject(String.valueOf(slotId)).put("selectTags", selectTags);
      UserSyncData.getJSONObject("status").put("recruitLicense",
            Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("recruitLicense") - 1));
   ...
   public JSONObject finishNormalGacha(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
         HttpServletResponse response, HttpServletRequest request) {
      String clientIp = ArknightsApplication.getIpAddr(request);
      ...
      JSONArray availCharInfo = ArknightsApplication.normalGachaData.getJSONObject("detailInfo")
            .getJSONObject("availCharInfo").getJSONArray("perAvailList");
      ...
      UserSyncData.getJSONObject("recruit").getJSONObject("normal").getJSONObject("slots")
            .getJSONObject(String.valueOf(slotId)).put("state", Integer.valueOf(1));
      UserSyncData.getJSONObject("recruit").getJSONObject("normal").getJSONObject("slots")
            .getJSONObject(String.valueOf(slotId)).put("selectTags", new JSONArray());
   ...
   public JSONObject advancedGacha(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
         HttpServletResponse response, HttpServletRequest request) {
      String clientIp = ArknightsApplication.getIpAddr(request);
   ...
   public JSONObject tenAdvancedGacha(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
         HttpServletResponse response, HttpServletRequest request) {
      String clientIp = ArknightsApplication.getIpAddr(request);
   ...
   public JSONObject Gacha(String type, int useDiamondShard, String secret, JSONObject JsonBody) {
      ...
      for (int count = 0; count < usedimmond; count++) {
         ...
         if (JsonBody.getString("poolId").equals("BOOT_0_1_1")) {
            ...
            UserSyncData.getJSONObject("status").put("gachaCount",
                  Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("gachaCount") + 1));
            ...
            int cnt = Pool.getIntValue("cnt") + 1;
            UserSyncData.getJSONObject("gacha").getJSONObject(poolObjecName).getJSONObject(poolId).put("cnt",
                  Integer.valueOf(cnt));
            UserSyncData.getJSONObject("status").put("gachaCount",
                  Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("gachaCount") + 1));
            if (cnt == 10 && Pool.getBoolean("avail").booleanValue()) {
               UserSyncData.getJSONObject("gacha").getJSONObject(poolObjecName).getJSONObject(poolId).put("avail",
                     Boolean.valueOf(false));
               Minimum = Boolean.valueOf(true);
            }
         }
         JSONArray availCharInfo = poolJson.getJSONObject("detailInfo").getJSONObject("availCharInfo")
               .getJSONArray("perAvailList");

         JSONArray upCharInfo = poolJson.getJSONObject("detailInfo").getJSONObject("upCharInfo")
         ...
         for (int k = 0; k < UserSyncData.getJSONObject("troop").getJSONObject("chars").size(); k++) {
            if (UserSyncData.getJSONObject("troop").getJSONObject("chars").getJSONObject(String.valueOf(k + 1))
                  .getString("charId").equals(randomCharId)) {
               repeatCharId = k + 1;
         ...
         if (repeatCharId == 0) {
            ...
            UserSyncData.getJSONObject("status").put(itemName,
                  Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue(itemName) + count));
      ...
      if (useTkt == 1 || useTkt == 2) {
         ...
         UserSyncData.getJSONObject("status").put(type,
               Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue(type) - 1));
      } else {

         UserSyncData.getJSONObject("status").put("diamondShard",
               Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("diamondShard") - useDiamondShard));
      }
