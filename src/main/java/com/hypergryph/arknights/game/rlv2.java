...
public class rlv2 {
  ...
  public JSONObject createGame(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     current.getJSONObject("player").getJSONObject("property").getJSONObject("population").put("cost", Integer.valueOf(0));
     current.getJSONObject("player").getJSONObject("property").getJSONObject("population").put("max", Integer.valueOf(6));
       ...
       for (int i = 0; i < buffDisplayInfo.size(); i++) {
         ...
         if (displayForm.equals("ABSOLUTE_VAL")) {          
           if (displayType.equals("display_gold")) {
             current.getJSONObject("player").getJSONObject("property").put("gold", Integer.valueOf(current.getJSONObject("player").getJSONObject("property").getIntValue("gold") + displayNum));
          }
          
           if (displayType.equals("display_hp")) {
             current.getJSONObject("player").getJSONObject("property").put("hp", Integer.valueOf(current.getJSONObject("player").getJSONObject("property").getIntValue("hp") + displayNum));
          }
          
           if (displayType.equals("display_squad_capacity")) {
             current.getJSONObject("player").getJSONObject("property").put("capacity", Integer.valueOf(current.getJSONObject("player").getJSONObject("property").getIntValue("capacity") + displayNum));
          }
          
           if (displayType.equals("display_temp_hp")) {
             current.getJSONObject("buff").put("tmpHP", Integer.valueOf(current.getJSONObject("buff").getIntValue("tmpHP") + displayNum));
          }
        } 
      } 
    } 
     ...
     initRecruitSet.put("option", JSONArray.parseArray("[\"recruit_group_1\",\"recruit_group_2\",\"recruit_group_3\",\"recruit_group_random\"]"));
  ...
  public JSONObject chooseInitialRelic(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     for (int i = 0; i < buffs.size(); i++) {
       ...
       if (key.equals("level_life_point_add")) {
         current.getJSONObject("buff").put("tmpHP", Integer.valueOf(current.getJSONObject("buff").getIntValue("tmpHP") + blackboard.getJSONObject(0).getIntValue("value")));
      }      
       if (key.equals("immediate_reward")) {
         ...
         if (type.equals("POPULATION")) {
           property.getJSONObject("population").put("max", Integer.valueOf(property.getJSONObject("population").getIntValue("max") + count));
        }
      }       
  ...
  public JSONObject chooseInitialRecruitSet(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     current.getJSONObject("player").getJSONArray("pending").getJSONObject(0).getJSONObject("content").getJSONObject("initRecruit").put("tickets", JSONArray.parseArray("[\"t_1\",\"t_2\",\"t_3\"]"));
  ...
  public JSONObject activeRecruitTicket(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     JSONObject tempChar = JSONObject.parseObject("{\"instId\":\"0\",\"charId\":\"temp\",\"type\":\"THIRD_LOW\",\"evolvePhase\":1,\"level\":55,\"exp\":0,\"favorPoint\":25570,\"potentialRank\":0,\"mainSkillLvl\":7,\"skills\":[],\"defaultSkillIndex\":0,\"skin\":\"temp\",\"upgradeLimited\":false,\"upgradePhase\":0,\"isUpgrade\":false,\"population\":0}");
     ...
     for (int i = 0; i < extraCharIds.size(); i++) {
       ...
       list.add(JSONObject.parseObject(JSONObject.toJSONString(tempChar, new SerializerFeature[] { SerializerFeature.DisableCircularReferenceDetect })));
    } 
    ...
    int j;
     for (j = 0; j < relicsBuffs.size(); j++) {
       if (relicsBuffs.getJSONObject(j).getString("key").equals("dynamic_update")) {
         String band = relicsBuffs.getJSONObject(j).getJSONArray("blackboard").getJSONObject(0).getString("valueStr").substring("recruit_upgrade_".length()).toUpperCase(Locale.ROOT);
  ...
  public JSONObject recruitChar(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     ticket.put("result", JSONObject.parseObject(JSONObject.toJSONString(optChar, new SerializerFeature[] { SerializerFeature.DisableCircularReferenceDetect })));
     ticket.put("state", Integer.valueOf(2));
    
     current.getJSONObject("player").getJSONObject("property").getJSONObject("population").put("cost", Integer.valueOf(current.getJSONObject("player").getJSONObject("property").getJSONObject("population").getIntValue("cost") + optChar.getIntValue("population")));
       ...
       if (event.getString("type").equals("RECRUIT")) {
         if (event.getJSONObject("content").getJSONObject("recruit").getString("ticket").equals(ticketIndex)) {
           ...
           if (pending.getJSONObject(pendingIndex).getString("type").equals("BATTLE_REWARD")) {
             JSONObject battleReward = pending.getJSONObject(pendingIndex).getJSONObject("content").getJSONObject("battleReward");            
         ...
         current.getJSONObject("inventory").getJSONObject("recruit").remove(event.getJSONObject("content").getJSONObject("recruit").getString("ticket"));
        continue;
      } 
  ...
  public JSONObject closeRecruitTicket(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     for (int i = 0; i < pending.size(); i++) {
       if (pending.getJSONObject(i).getString("type").equals("RECRUIT") && 
         pending.getJSONObject(i).getJSONObject("content").getJSONObject("recruit").getString("ticket").equals(ticketIndex)) {
         pending.remove(i);
      }
    }     
     userDao.setUserData(uid, UserSyncData);
  ...
  public JSONObject finishEvent(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     for (int n = 0; n < current.getJSONObject("player").getJSONArray("pending").size(); n++) {
       ...
       if (current.getJSONObject("player").getJSONArray("pending").size() == 1 && 
         current.getJSONObject("player").getJSONArray("pending").getJSONObject(n).getString("type").equals("GAME_INIT_RECRUIT")) {
         ...
         current.getJSONObject("map").put("zones", ArknightsApplication.roguelike.getJSONObject("rlv2").getJSONObject("customMap").getJSONObject("zones"));
      }       
       if (current.getJSONObject("player").getJSONArray("pending").size() != 0 && 
         current.getJSONObject("player").getJSONArray("pending").getJSONObject(n).getString("type").equals("GAME_INIT_MODE_RELIC")) {
        
         String theme = current.getJSONObject("game").getString("theme");
         JSONObject property = current.getJSONObject("player").getJSONObject("property");
         JSONObject roguelikeItems = ArknightsApplication.roguelikeTable.getJSONObject("details").getJSONObject(theme).getJSONObject("items");
        
         JSONArray items = current.getJSONObject("player").getJSONArray("pending").getJSONObject(n).getJSONObject("content").getJSONObject("initModeRelic").getJSONArray("items");
         ...
         for (int i = 0; i < items.size(); i++) {
           ...
           if (ArknightsApplication.roguelikeTable.getJSONObject("details").getJSONObject(theme).getJSONObject("relics").containsKey(itemId)) {            
  ...
  public JSONObject unlockBuff(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     outer.getJSONObject("buff").put("pointCost", Integer.valueOf(outer.getJSONObject("buff").getIntValue("pointCost") + outBuff.getIntValue("tokenCost")));
  ...
  public JSONObject battleFinish(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
     ...
     current.getJSONObject("player").getJSONObject("property").put("capacity", Integer.valueOf(current.getJSONObject("player").getJSONObject("property").getIntValue("capacity") + 1));
    
     current.getJSONObject("player").getJSONObject("property").getJSONObject("population").put("max", Integer.valueOf(current.getJSONObject("player").getJSONObject("property").getJSONObject("population").getIntValue("max") + 4));
  ...
  public JSONObject chooseBattleReward(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody, HttpServletResponse response, HttpServletRequest request) {
    ...
    int j;
     ...
     for (j = 0; j < items.size(); j++) {
       ...
       if (type.equals("POPULATION")) {
         property.getJSONObject("population").put("max", Integer.valueOf(property.getJSONObject("population").getIntValue("max") + itemCount));
      }
        ...
        int k;
         for (k = 0; k < relicsBuffs.size(); k++) {
           if (relicsBuffs.getJSONObject(k).getString("key").equals("dynamic_update")) {
             String band = relicsBuffs.getJSONObject(k).getJSONArray("blackboard").getJSONObject(0).getString("valueStr").substring("recruit_upgrade_".length()).toUpperCase(Locale.ROOT);
             dynamicUpdateList.add(band);
          } 
        } 
