...
public class social {
  ...
  public JSONObject setAssistCharList(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
    ...
    for (int i = 0; i < assistCharList.size(); i++) {
      if (assistCharList.getJSONObject(i) != null) {
        ...
        String charId = UserSyncData.getJSONObject("troop").getJSONObject("chars").getJSONObject(charInstId)
            .getString("charId");
  ...
  public JSONObject getSortListInfo(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response) {
  ...
  public JSONObject getFriendList(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response) {
  ...
  public JSONObject searchPlayer(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response) {
    JSONArray idList = JsonBody.getJSONArray("idList");
  ...
  public JSONObject getFriendRequestList(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response) {
    JSONArray idList = JsonBody.getJSONArray("idList");
  ...
  public JSONObject processFriendRequest(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response) {
  ...
  public JSONObject sendFriendRequest(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response) {
  ...
  public JSONObject setFriendAlias(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response) {
  ...
  public JSONObject deleteFriend(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response) {
    long friendId = JsonBody.getIntValue("friendId");
