...
public class quest {
  ...
  public JSONObject BattleFinish(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
    ...
    if (UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId)
        .getIntValue("practiceTimes") == 1) {

      if (UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId)
          .getIntValue("state") == 0) {
        UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId).put("state",
            Integer.valueOf(1));
      }
      UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId).put("practiceTimes",
          Integer.valueOf(0));
    ...
    UserSyncData.getJSONObject("status").put("ap",
        Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("ap") - apCost));
    if (completeState == 1) {
      ...
      if (UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId)
        ...
        UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId).put("noCostCnt",
            Integer.valueOf(0));
      }
        ...
        if (dropType == 1 || dropType == 8) {
          if (reward_type.equals("CHAR")) {
            ...
            for (int n = 0; n < UserSyncData.getJSONObject("troop").getJSONObject("chars").size(); n++) {
              if (UserSyncData.getJSONObject("troop").getJSONObject("chars").getJSONObject(String.valueOf(n + 1))
            ...
            if (repeatCharId == 0) {
              ...
              JSONArray skilsArray = ArknightsApplication.characterJson.getJSONObject(randomCharId)
                  .getJSONArray("skills");
              ...
              JSONObject charinstId = new JSONObject(true);
              charinstId.put(String.valueOf(repeatCharId), UserSyncData.getJSONObject("troop").getJSONObject("chars")
                  .getJSONObject(String.valueOf(repeatCharId)));
              chars.put(String.valueOf(repeatCharId), UserSyncData.getJSONObject("troop").getJSONObject("chars")
                  .getJSONObject(String.valueOf(repeatCharId)));
              troop.put("chars", charinstId);
            }
            ...
            if (reward_type.equals("FURN")) {
              ...
              UserSyncData.getJSONObject("building").getJSONObject("furniture").getJSONObject(reward_id).put("count",
                  Integer.valueOf(UserSyncData.getJSONObject("building").getJSONObject("furniture")
                      .getJSONObject(reward_id).getIntValue("count") + 1));
            }
            JSONObject first_reward = new JSONObject(true);
    ...
    UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId).put("completeTime",
        Integer.valueOf(BattleData.getJSONObject("battleData").getIntValue("completeTime")));

    JSONArray playerExpMap = JSON.parseArray(
        "[500,800,1240,1320,1400,1480,1560,1640,1720,1800,1880,1960,2040,2120,2200,2280,2360,2440,2520,2600,2680,2760,2840,2920,3000,3080,3160,3240,3350,3460,3570,3680,3790,3900,4200,4500,4800,5100,5400,5700,6000,6300,6600,6900,7200,7500,7800,8100,8400,8700,9000,9500,10000,10500,11000,11500,12000,12500,13000,13500,14000,14500,15000,15500,16000,17000,18000,19000,20000,21000,22000,23000,24000,25000,26000,27000,28000,29000,30000,31000,32000,33000,34000,35000,36000,37000,38000,39000,40000,41000,42000,43000,44000,45000,46000,47000,48000,49000,50000,51000,52000,54000,56000,58000,60000,62000,64000,66000,68000,70000,73000,76000,79000,82000,85000,88000,91000,94000,97000,100000]");
    JSONArray playerApMap = JSON.parseArray(
        "[82,84,86,88,90,91,92,93,94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,120,120,120,120,121,121,121,121,121,122,122,122,122,122,123,123,123,123,123,124,124,124,124,124,125,125,125,125,125,126,126,126,126,126,127,127,127,127,127,128,128,128,128,128,129,129,129,129,129,130,130,130,130,130,130,130,130,130,130,130,130,130,130,130,130,131,131,131,131,132,132,132,132,133,133,133,133,134,134,134,134,135,135,135,135]");
    ...
    if (level < 120 &&
      ...
      for (int k = 0; k < playerExpMap.size(); k++) {
        if (level == k + 1) {
          if (Integer.valueOf(playerExpMap.get(k).toString()).intValue()
              - UserSyncData.getJSONObject("status").getIntValue("exp") <= 0) {
            if (k + 2 == 120) {
              ...
              UserSyncData.getJSONObject("status").put("exp",
                  Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("exp")
                      - Integer.valueOf(playerExpMap.get(k).toString()).intValue()));
              UserSyncData.getJSONObject("status").put("maxAp", playerApMap.get(k + 1));
              UserSyncData.getJSONObject("status").put("ap",
                  Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("ap")
                      + UserSyncData.getJSONObject("status").getIntValue("maxAp")));
      ...
      if (UserSyncData.getJSONObject("troop").getJSONObject("chars").containsKey(instId)) {
        ...
        if (completeState == 3 || completeState == 4) {
          ...
          if (UserSyncData.getJSONObject("troop").getJSONObject("charGroup").containsKey(charId))
            UserSyncData.getJSONObject("troop").getJSONObject("charGroup").getJSONObject(charId).put("favorPoint",
                Integer.valueOf(charFavor + completeFavor));
          continue;
        }
        charData.put("favorPoint", Integer.valueOf(charFavor + passFavor));
        if (UserSyncData.getJSONObject("troop").getJSONObject("charGroup").containsKey(charId)) {
          UserSyncData.getJSONObject("troop").getJSONObject("charGroup").getJSONObject(charId).put("favorPoint",
              Integer.valueOf(charFavor + passFavor));
        }
      }
    }
    JSONObject playerDataDelta = new JSONObject(true);
    ...
    for (int j = 0; j < unlockStagesObject.size(); j++) {
      ...
      stages.put(unlock_stageId,
          UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(unlock_stageId));
    }
    stages.put(stageId, UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId));
  ...
  public JSONObject SquadFormation(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response, HttpServletRequest request) {
    String clientIp = ArknightsApplication.getIpAddr(request);
    ...
    UserSyncData.getJSONObject("troop").getJSONObject("squads").getJSONObject(squadId).put("slots",
        JsonBody.getJSONArray("slots"));
  ...
  public JSONObject SaveBattleReplay(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response, HttpServletRequest request) {
    String clientIp = ArknightsApplication.getIpAddr(request);
  ...
  public JSONObject GetBattleReplay(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response, HttpServletRequest request) {
    String clientIp = ArknightsApplication.getIpAddr(request);
    ...
    playerDataDelta.put("modified", modified);
    result.put("playerDataDelta", playerDataDelta);
    result.put("battleReplay",
        UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId).getString("battleReplay"));
    return result;
  }

  @PostMapping(value = { "/changeSquadName" }, produces = { "application/json;charset=UTF-8" })
  public JSONObject ChangeSquadName(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response, HttpServletRequest request) {
    String clientIp = ArknightsApplication.getIpAddr(request);
  ...
  public JSONObject getAssistList(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response, HttpServletRequest request) {
    String clientIp = ArknightsApplication.getIpAddr(request);
        ...
        if (!assistCharArray.contains(charId)) {
          ...
          for (int m = 0; m < userSocialAssistCharList.size(); m++) {
            if (userSocialAssistCharList.getJSONObject(m) != null) {
              JSONObject charData = chars
                  .getJSONObject(userSocialAssistCharList.getJSONObject(m).getString("charInstId"));
              charData.put("skillIndex",
                  Integer.valueOf(userSocialAssistCharList.getJSONObject(m).getIntValue("skillIndex")));
    ...
    for (j = 0; j < searchAssist.size(); j++) {
      ...
      if (friendUid != -1L) {
        ...
        JSONArray userSocialAssistCharList = JSONArray
            .parseArray(((SearchAssistCharList) searchAssist.get(j)).getSocialAssistCharList());
  ...
  public JSONObject finishStoryStage(@RequestHeader("secret") String secret, @RequestBody JSONObject JsonBody,
      HttpServletResponse response, HttpServletRequest request) {
    String clientIp = ArknightsApplication.getIpAddr(request);
    ...
    int stage_state = UserSyncData.getJSONObject("dungeon").getJSONObject("stages").getJSONObject(stageId)
        .getIntValue("state");
    ...
    if (stage_state != 3) {
      ...
      UserSyncData.getJSONObject("status").put("androidDiamond",
          Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("androidDiamond") + 1 * DropRate));
      UserSyncData.getJSONObject("status").put("iosDiamond",
          Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("iosDiamond") + 1 * DropRate));
    }
