 ...
 public class admin
 {
   public static void GM_GiveItem(JSONObject UserSyncData, String reward_id, String reward_type, int reward_count, JSONArray items) {
     ...
     if (reward_type.equals("HGG_SHD")) {
       UserSyncData.getJSONObject("status").put("practiceTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("hggShard") + reward_count));
     }
     if (reward_type.equals("LGG_SHD")) {
       UserSyncData.getJSONObject("status").put("practiceTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("lggShard") + reward_count));
     }
     ...
     if (reward_type.equals("SOCIAL_PT")) {
       UserSyncData.getJSONObject("status").put("socialPoint", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("socialPoint") + reward_count));
     }
     if (reward_type.equals("AP_GAMEPLAY")) {
       UserSyncData.getJSONObject("status").put("ap", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("ap") + reward_count));
     }
     if (reward_type.equals("AP_ITEM")) {
       if (reward_id.contains("60")) {
         UserSyncData.getJSONObject("status").put("ap", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("ap") + 60));
       } else if (reward_id.contains("200")) {
         UserSyncData.getJSONObject("status").put("ap", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("ap") + 200));
       } else {
         UserSyncData.getJSONObject("status").put("ap", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("ap") + 100));
       } 
     }
     if (reward_type.equals("TKT_TRY")) {
       UserSyncData.getJSONObject("status").put("practiceTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("practiceTicket") + reward_count));
     }
     ...
     if (reward_type.equals("DIAMOND_SHD")) {
       UserSyncData.getJSONObject("status").put("diamondShard", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("diamondShard") + reward_count));
     }
     ...
     if (reward_type.equals("TKT_INST_FIN")) {
       UserSyncData.getJSONObject("status").put("instantFinishTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("instantFinishTicket") + reward_count));
     }
     ...
     if (reward_type.equals("TKT_GACHA_10")) {
       UserSyncData.getJSONObject("status").put("tenGachaTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("tenGachaTicket") + reward_count));
     }
     if (reward_type.equals("TKT_GACHA")) {
       UserSyncData.getJSONObject("status").put("gachaTicket", Integer.valueOf(UserSyncData.getJSONObject("status").getIntValue("gachaTicket") + reward_count));
     }
     if (reward_type.indexOf("VOUCHER") != -1) {
       ...
       UserSyncData.getJSONObject("consumable").getJSONObject(reward_id).getJSONObject("0").put("count", Integer.valueOf(UserSyncData.getJSONObject("consumable").getJSONObject(reward_id).getJSONObject("0").getIntValue("count") + reward_count));
     } 
     if (reward_type.equals("CHAR_SKIN")) {
       ...
       UserSyncData.getJSONObject("skin").getJSONObject("skinTs").put(reward_id, Long.valueOf((new Date()).getTime() / 1000L));
     } 
