 ...
 public class official
 {
   ...
   public ResponseEntity<FileSystemResource> getFile(@PathVariable("os") String os, @PathVariable("assetsHash") String assetsHash, @PathVariable("fileName") String fileName, HttpServletResponse response, HttpServletRequest request) throws IOException {
     ...
     Boolean redirect = Boolean.valueOf(ArknightsApplication.serverConfig.getJSONObject("assets").getBooleanValue("enableRedirect"));
     String version = ArknightsApplication.serverConfig.getJSONObject("version").getJSONObject("android").getString("resVersion");
     ...
     HttpUtil.downloadFile("https://ak.hycdn.cn/assetbundle/official/Android/assets/" + version + "/" + fileName, filePath + fileName);
